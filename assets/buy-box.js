  ...
  container.innerHTML = `
    ...
    ${data.showCongrats ? `
        ...
        <div class="choose-flavor__btn-wrapper">
          ...
          <div><span><span><img src="https://cdn.shopify.com/s/files/1/0852/8553/6031/files/Group_1484580410.png?v=1726037646" class="value-point__icon"></span>Expected delivery in 3-5 business days</div>
        </div>
    </div>
  `;
