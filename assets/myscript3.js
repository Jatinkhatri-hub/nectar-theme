jQuery(document).ready(function () {
  ...
  function a(t = "body") {
      var e = $(".product_swatches_row3 .option-selector.active").attr("data-value") + "-" + $(".product-flavor_dropdown3 li.active").attr("data-option");
      $(t)
          .closest("form")
  ...
  $(".product-variant-select-drop-toggle").on("click", function () {
      ...
      $(".product-variant-select-a li").click(function () {
          ...
          var i = $(this).attr("data-image3");
          
              $(".product-img3").length > 0
                  ? $(".product-img3").attr("src", i)
      ...
      $(".product-flavor_dropdown3").click(function (t) {
          $(this).find("ul").toggleClass("active");
      }),
      $(".product-flavor_dropdown3 li").click(function (t) {
          $(this).hasClass("active") || ($(".product-flavor_dropdown3 li").removeClass("active"), $(this).addClass("active"), console.log($(this).attr("data-option")), a($(this)));
      }),
      $(".product_swatches_row3 .option-selector").click(function (t) {
          $(".product_swatches_row3 .option-selector").removeClass("active"), $(this).addClass("active"), a($(this));
        var desc = $(".product-description3").html();
          if (desc === "Daily Electrolyte Drink Mix") {
            $(".product-description3").html("Electrolytes + 75mg Organic Caffeine + L-Theanine + B12");
          } else {
            $(".product-description3").html("Daily Electrolyte Drink Mix");
          }
      }),
      a();
});